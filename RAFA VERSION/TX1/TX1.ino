/* EMITTER1
   ...
   THIS PROGRAM SENDS THE VALUE OF THE DS18B20 SENSOR TEMPERATURE TO GOBLIN 2
   CONFIGURED AS A RECEIVER, THIS HAS THE RADIOFREQUENCY SHIELD.
